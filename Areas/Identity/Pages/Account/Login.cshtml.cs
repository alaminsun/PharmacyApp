...
namespace PhramacyApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : BasePageModel<LoginModel>
    {
        ...
        public async Task<IActionResult> OnPostAsync(string userId, string action, string returnUrl = null)
        {
                ...
                if (user != null)
                {
                    ...
                    else
                    {
                        ...
                        if (result.Succeeded)
                        {
                            ...
                            await _logRepository.AddLogAsync(action, userId);
